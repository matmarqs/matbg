...
We compare the characters in Equation \ref{eq:characters_rho_inducedrep_k, eq:characters_rhoC3_k_Gamma_K} to the character tables \ref{tab:D6_double, tab:D3_double_littlegroup_K, tab:D2_double}, in order to discover the multiplicities in Equation \ref{eq:induce_subduce}.
...
\specialrule{0.01em}{0.2em}{0.2em}
$\rho_G^\Gamma$ & $\P4$ & $\P2$ & $\P0$ & $\P0$ & $\P0$ & $\P0$ & $ -4$ & $ -2$ & $\P0$ \\
