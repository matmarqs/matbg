...
def eigenval(k):       # generate eigenvalues
    ...
    f2 = interp1d([u_Gamma, u_K/2, u_K, u_M], [2, 2.5, 3, 4], kind="cubic", fill_value="extrapolate")
    f3 = interp1d([u_Gamma, u_K/2, u_K, u_M], [4, 3.5, 3, 2], kind="cubic", fill_value="extrapolate")
    f4 = interp1d([u_Gamma, u_K/2, u_K, u_M], [4, 4.5, 5, 4], kind="cubic", fill_value="extrapolate")
